...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6025804407161161182L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"kafka.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"createtime\",\"type\":\"string\"}]}");
   ...
   */
  public Message(java.lang.CharSequence id, java.lang.CharSequence type, java.lang.CharSequence createtime) {
    this.id = id;
    this.type = type;
   ...
   */
  public static kafka.avro.Message.Builder newBuilder() {
    return new kafka.avro.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static kafka.avro.Message.Builder newBuilder(kafka.avro.Message.Builder other) {
    if (other == null) {
      return new kafka.avro.Message.Builder();
    } else {
      return new kafka.avro.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static kafka.avro.Message.Builder newBuilder(kafka.avro.Message other) {
    if (other == null) {
      return new kafka.avro.Message.Builder();
    } else {
      return new kafka.avro.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(kafka.avro.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(kafka.avro.Message other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Message.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Message.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Message.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Message.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Message.Builder setCreatetime(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public kafka.avro.Message.Builder clearCreatetime() {
      createtime = null;
